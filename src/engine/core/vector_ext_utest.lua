...
describe('projected_coord', function ()

  it('(2 -1).projected_coord(0 0) => assert', function ()
    assert.has_error(function ()
      vector(0, 0):projected_coord(4, 0)
    end)
  end)

  it('(2 -1).projected_coord(4 0) => (2, 0)', function ()
    assert.are_equal(2, vector(2, -1):projected_coord(vector(4, 0)))
  end)

  it('(2 -1).projected_coord(0 -10) => (0, -1)', function ()
    assert.are_equal(1, vector(2, -1):projected_coord(vector(0, -10)))
  end)

  it('(1 0).projected_coord(2 -2) => (0.5, -0.5)', function ()
    assert.are_equal(1/sqrt(2), vector(1, 0):projected_coord(vector(2, -2)))
  end)

  it('(1 3).projected_coord(1 -2) => (0.5, -0.5)', function ()
    assert.are_equal(-sqrt(5), vector(1, 3):projected_coord(vector(1, -2)))
  end)

end)

describe('projected_parallel', function ()

  it('(2 -1).projected_parallel(0 0) => assert', function ()
    assert.has_error(function ()
      vector(0, 0):projected_parallel(4, 0)
    end)
  end)

  it('(2 -1).projected_parallel(4 0) => (2, 0)', function ()
    assert.are_equal(vector(2, 0), vector(2, -1):projected_parallel(vector(4, 0)))
  end)

  it('(2 -1).projected_parallel(0 -10) => (0, -1)', function ()
    assert.are_equal(vector(0, -1), vector(2, -1):projected_parallel(vector(0, -10)))
  end)

  it('(1 0).projected_parallel(2 -2) => (0.5, -0.5)', function ()
    assert.are_equal(vector(0.5, -0.5), vector(1, 0):projected_parallel(vector(2, -2)))
  end)

  it('(1 3).projected_parallel(1 -2) => (0.5, -0.5)', function ()
    assert.are_equal(vector(-1, 2), vector(1, 3):projected_parallel(vector(1, -2)))
  end)
